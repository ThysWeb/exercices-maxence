...
if (readCookie("nbVisite") == null) {
    createCookie("nbVisite", 1, 3);
}
else {
    createCookie("nbVisite", parseInt(readCookie("nbVisite")) + 1, 3);
}

paragraphe.innerHTML = "Nombre de visite: " + readCookie("nbVisite");
